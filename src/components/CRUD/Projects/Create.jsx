...
const CreateProject = () => {
  ...
  const validateForm = () => {
    ...
    if (
      !formData.numberOfBlocks ||
      isNaN(formData.numberOfBlocks) ||
      Number(formData.numberOfBlocks) <= 0
    ) {
      newErrors.numberOfBlocks =
        "Number of blocks must be a number greater than 0";
    }
